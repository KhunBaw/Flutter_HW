...
class MyFriend extends StatelessWidget {
  ...
  final List<String> _heroDetails = [
    "เป็นเพื่อนที่ดีถึงจะไม่ค่อยอาบน้ำเหมือนผม อยากให้มันมีแฟนมานานแล้วแต่ไม่สมหวังสักที ยังไงๆ ก็เป็นเพื่อนที่ดีที่สุดสำหรับผม",
    "คนนี้หญิงแกร่ง ถือว่าเป็นผู้หญิงคนหนึ่งที่รู้เรื่องคอมมากที่สุดเท่าที่เคยเจอมา ถ้าไม่นับครูอาจารย์ และพอที่จะคุยด้วยภาษาเทพได้นิดหน่อย ผมพยายามให้จิ๋วทำงานด้วยตัวเองให้มากที่สุดเสมอ อยากให้เก่งได้เท่าๆ ผม ชอบบ่นให้ฟังบ่อยๆ ผมก็ชอบฟังไม่รู้ทำไม",
    "อาร์ม คนนี้ขยันมาก ทำไม่เป็นก็ยังดินรนตัวเอง อยากให้จบพร้อมๆกัน",
    "ลิป ผมพยายามตีสนิดมานานแล้วแต่เหมือนจะเข้าไม่ถึงแก่นสารสักที ยังไงๆก็ชอบมุขตลก ที่เล่นๆอยู่มาก คือแบบคิดได้ไง",
  ];
